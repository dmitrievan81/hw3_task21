...
class Program
{
   ...
   public int GetNumber(string VarName)
    ...
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("The program calculates the distance between two points.");

        Point3d p1 = pr.GetPoint3d("p1");
        Point3d p2 = pr.GetPoint3d("p2");

        double distance = pr.GetDistance(p1, p2);
        
        string text_msg_format = "distance between two points is {0} .";
        Console.WriteLine(String.Format(text_msg_format, distance));
